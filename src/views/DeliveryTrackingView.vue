...
const deliveryId = ref(String(route.query.delivery ?? ''))
...
<template>
  <div>
    ...
    <AppCard class="mb-4" title="Delivery" icon="lucide:truck">
      <div class="flex flex-col gap-2 sm:flex-row sm:items-end"><AppInput v-model="deliveryId" class="flex-1" label="Delivery ID" placeholder="Pilih dari daftar pengiriman" /><AppButton icon="lucide:refresh-cw" :loading="loading" :disabled="!deliveryId" @click="refresh">Perbarui</AppButton></div>
    </AppCard>
