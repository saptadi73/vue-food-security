...
export const masterRegistry: Record<string, MasterDefinition> = {
  ...
  'supplier-materials': {
    ...
    singular: 'relasi',
    description: 'Daftar bahan yang dapat dipasok oleh setiap pemasok. Tabel menampilkan nama; UUID dikelola sistem.',
    icon: 'lucide:link',
    permission: 'SupplierMaterial.Read',
    idKey: 'supplier_material_id',
    identityKey: 'supplier_material_id',
    searchKeys: ['supplier_name', 'supplier_code', 'material_name', 'material_code', 'supplier_id', 'raw_material_id'],
    columns: [
      { key: 'supplier_name', label: 'Pemasok' },
      { key: 'material_name', label: 'Bahan baku' },
      versionColumn,
      updatedColumn,
    ],
    fields: [
